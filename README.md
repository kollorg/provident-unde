...
![CodeQL](https://github.com/kollorg/provident-unde/workflows/CodeQL/badge.svg)
![CI test](https://github.com/kollorg/provident-unde/workflows/ci-test/badge.svg)
[![Coverage Status](https://img.shields.io/coveralls/github/kollorg/provident-unde)](https://coveralls.io/github/kollorg/provident-unde?branch=main)
...
```bash
npm i @kollorg/provident-unde
```

```ts
import { extract } from '@kollorg/provident-unde'
...
```ts
import { extract } from 'npm:@kollorg/provident-unde'
```

### Browser

```ts
import { extract } from 'https://esm.sh/@kollorg/provident-unde'
```

Please check [the examples](https://github.com/kollorg/provident-unde/tree/main/examples) for reference.
...
CJS is deprecated for this package.  When calling `require('@kollorg/provident-unde')` a deprecation warning is now logged.  You should update your code to use the ESM export.
...
Passing requests to proxy is useful while running `@kollorg/provident-unde` on browser.
...
```js
import { extractFromJson } from '@kollorg/provident-unde'
...
```js
import { extractFromXml } from '@kollorg/provident-unde'
...
```bash
git clone https://github.com/kollorg/provident-unde.git
cd feed-extractor
pnpm i
pnpm test
```
